  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="w-80 border-r p-4 overflow-y-auto bg-white">
        ...
        {zones.map(zone => (
            <div key={zone.id} onMouseEnter={() => setHoveredZoneId(zone.id)} onMouseLeave={() => setHoveredZoneId(null)}
      ...
      <div className="flex-1 p-8 flex items-start justify-center bg-gray-50">
        ...
        {selectedVideo ? (
          <div className="relative max-w-4xl w-full aspect-video">
            ...
            <ZoneCanvas zones={zones} points={[]} setPoints={() => {}} editable={false} hoveredZoneId={hoveredZoneId} />
          </div>
        ) : (
